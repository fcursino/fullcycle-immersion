...
type Book struct {
	...
	OrdersChan    chan *Order //input do kafka
	OrdersChanOut chan *Order
	Wg            *sync.WaitGroup
}

func NewBook(orderChan chan *Order, orderChanOut chan *Order, wg *sync.WaitGroup) *Book { //cria livro de registros de compra e venda
	return &Book{
		Order:         []*Order{},
		Transactions:  []*Transaction{},
...
func (b *Book) AddTransaction(transaction *Transaction, wg *sync.WaitGroup) {
	defer wg.Done() //defer roda o comando por último
